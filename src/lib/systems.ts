...
export const SYSTEMS: SolarSystem[] = [
  {
    ...
    stats: [
      ...
      { value: "~24kWh", label: "Daily generation" },
  ...
  },
  {
    ...
    stats: [
      { value: "10.12kW", label: "System size" },
      { value: "~38kWh", label: "Daily generation" },
  ...
  },
  {
    ...
    stats: [
      { value: "13.2kW", label: "System size" },
      { value: "~50kWh", label: "Daily generation" },
  ...
  },
  {
    ...
    category: "residential",
    size: "20kW",
    audience: "Estates & light commercial",
    tagline: "Big-roof power for estates, workshops and energy-hungry homes.",
    price: 11990,
    perDay: 15,
    termMonths: 24,
    savingsPerYear: 4200,
    ...
    stats: [
      ...
      { value: "~76kWh", label: "Daily generation" },
      { value: "$4,200", label: "Annual savings" },
      { value: "25 yr", label: "Panel warranty" },
    ],
  },
  {
