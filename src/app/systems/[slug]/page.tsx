    ...
    <SiteLayout>
      ...
      <section className="bg-white pb-16 pt-12">
        <div className="container-ke">
          {/* Breadcrumb */}
          <nav className="mb-7 flex items-center gap-2 font-body text-[13.5px] text-ash-500">
            <Link href="/" className="hover:text-forest-700">
              Home
            </Link>
            <Icon name="chevron" size={14} className="-rotate-90 opacity-50" />
            <span className="capitalize">{system.category} Solar</span>
            <Icon name="chevron" size={14} className="-rotate-90 opacity-50" />
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.05fr_1fr]">
            ...
            <div>
              ...
              <h1 className="mt-3 font-display text-[clamp(40px,5vw,64px)] font-extrabold leading-none tracking-[-0.025em] text-navy-800">
                {system.size}
              ...
              <div className="mt-7 flex flex-wrap items-end gap-8">
                ...
                <div>
                  ...
                  <div className="font-display text-[40px] font-extrabold leading-none text-green-600">
                    ...
                    <span className="ml-1 font-body text-[15px] font-semibold text-ash-500">
                      /yr
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-6 inline-flex items-center gap-2.5 font-body text-[13.5px] font-bold text-ash-700">
            ...
            <div className="relative h-[320px] overflow-hidden rounded-xl shadow-lg lg:h-[440px]">
              <Image
                src="/assets/photo-panels.jpg"
                alt={`${system.size} rooftop solar installation`}
                fill
                priority
