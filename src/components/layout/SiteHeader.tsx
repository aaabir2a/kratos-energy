            ...
            return (
              ...
              >
                <button
                  ...
                  className={cn(
                    "inline-flex items-center gap-[5px] whitespace-nowrap rounded-sm border-b-2 px-[10px] py-2 font-display text-[14.5px] font-semibold transition-colors",
                    isActive
                ...
                {item.menu && (
                  ...
                  >
                    <div className="min-w-[224px] rounded-md border border-ash-200 bg-white p-2 shadow-lg">
                      {item.menu.map((sub) => (
                        <button
                          key={sub.label}
